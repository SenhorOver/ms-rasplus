package com.client.rasplus.api.customer.services.impl;

import com.client.rasplus.api.customer.components.HttpComponent;
...
import com.client.rasplus.api.customer.repositories.UserRecoveryCodeRepository;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private String getUserAuthId(String currentEmail, HttpHeaders headers) throws JsonProcessingException {
        ...
        if (users.isEmpty()) {
            throw new BadRequestException("Error to get user");
        }
